...
func CreatePPPoEUser(c *gin.Context) {
	routerID := c.Param("id")
	...
	LogAction(userID, router.ID, "CREATE_PPPOE_USER", body.Username)

	c.JSON(http.StatusCreated, gin.H{"message": "PPPoE user created"})
}
